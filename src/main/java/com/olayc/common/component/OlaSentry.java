package com.olayc.common.component;
 ...
 * copy&change from io.sentry.Sentry
 * @author jianbiao11
 */
public final class OlaSentry {
	private static final Logger logger = LoggerFactory.getLogger(io.sentry.Sentry.class);
	/**
	 * The most recently constructed {@link SentryClient} instance, used by static helper
	 * methods like {@link io.sentry.Sentry#capture(Event)}.
	 */
	...
	public static SentryClient getStoredClient() {
		...
		synchronized (io.sentry.Sentry.class) {
	 ...
	 * @deprecated use {@link io.sentry.Sentry#getContext()} and then {@link Context#recordBreadcrumb(Breadcrumb)}.
	 */
	@Deprecated
	 ...
	 * @deprecated use {@link io.sentry.Sentry#getContext()} and then {@link Context#setUser(User)}.
	 */
	@Deprecated
