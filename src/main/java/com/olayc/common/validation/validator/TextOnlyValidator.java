...
public class TextOnlyValidator implements ConstraintValidator<PhoneNo, String> {

	private final String EMAIL_REGEX = "^[a-zA-Z]+$";

	@Override
	public boolean isValid(String value, ConstraintValidatorContext context) {
		if (isNotEmpty(value) && value.matches(EMAIL_REGEX)){
			return true;
		}
		return false;
	}
