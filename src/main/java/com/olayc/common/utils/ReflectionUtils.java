...
public class ReflectionUtils {
	...
	public static void makeAccessible(Method method) {
		boolean condition = (!Modifier.isPublic(method.getModifiers()) || !Modifier
	...
	public static void makeAccessible(Field field) {
		boolean condition = (!Modifier.isPublic(field.getModifiers()) || !Modifier
				.isPublic(field.getDeclaringClass().getModifiers()) || Modifier.isFinal(field.getModifiers())) && !field
				.isAccessible();
		if (condition) {
